...
const AudioVisual = () => {
  ...
  return (
      ...
      <SEO 
        title={service?.title || "AudioVisual"} 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-md">
              ...
              <span className="text-white text-sm font-semibold uppercase tracking-widest">Enterprise AV Integration</span>
            </div>
            <h1 className="mb-6 text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white">{service?.title || "Audio Visual Solutions"}</h1>
