    ...
    <div className="min-h-screen pt-32 md:pt-24 overflow-hidden relative">
      ...
      <section className="relative min-h-[70vh] flex items-center mb-32 border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="mb-6 text-5xl md:text-7xl font-black">Industrial <br/><span className="text-blue-400">Wireless</span></h1>
            <p className="text-xl text-neutral-400 font-light leading-relaxed mb-8">
              We provide the specialized labor to execute precision LAN integration across sprawling factories and physically mount access points in hard-to-reach industrial ceilings, alongside expert software configuration.
            </p>
            <div className="flex gap-4">
              <Link to="/contact" className="bg-blue-600 text-white hover:bg-blue-500 px-8 py-4 rounded-full font-bold transition-all shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                Deploy Now
              </Link>
            </div>
          </motion.div>
          ...
          <motion.div 
            style={{ y: yHero }}
            className="relative h-[600px] rounded-3xl overflow-hidden glass-panel border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.1)]"
          >
            <img 
              src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&q=80&w=1000" 
              alt="Wireless Installation" 
              className="w-full h-full object-cover opacity-60 mix-blend-luminosity hover:mix-blend-normal transition-all duration-1000 hue-rotate-[160deg]"
            />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-40 mb-40">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=1000" className="w-full h-full object-cover rounded-2xl opacity-70 mix-blend-luminosity hover:mix-blend-normal transition-all duration-500" alt="Factory Installation" />
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img src="https://images.unsplash.com/photo-1517420704952-d9f39740e850?auto=format&fit=crop&q=80&w=1000" className="w-full h-full object-cover rounded-2xl opacity-70 mix-blend-luminosity hover:mix-blend-normal transition-all duration-500" alt="Roaming Configuration" />
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
