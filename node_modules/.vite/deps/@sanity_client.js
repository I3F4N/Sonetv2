...
function columnToLine(column, lines) {
  ...
  return {
    line: lines.length,
    column: ((_a = lines[lines.length - 1]) == null ? void 0 : _a.length) ?? 0
  };
}
...
...and ${allItems.length - MAX_ITEMS_IN_ERROR_MESSAGE} more`), props.message = `${error.description}${formatTraceId(props.traceId)}${itemsStr}`, props.details = body.error, props;
  ...
  if (isQueryParseError(error)) {
    const tag = (_b = (_a = context2 == null ? void 0 : context2.options) == null ? void 0 : _a.query) == null ? void 0 : _b.tag;
...
function extractTraceId(res) {
  var _a;
  const traceparent = (_a = res == null ? void 0 : res.headers) == null ? void 0 : _a.traceparent;
  if (traceparent)
...
var CorsOriginError = class extends Error {
  constructor({ projectId: projectId2, credentials } = {}) {
    ...
    if (this.name = "CorsOriginError", this.projectId = projectId2, projectId2 && typeof location < "u") {
      ...
      projectId2 ? this.message = `The current origin is not allowed to connect to the Live Content API. Change your configuration here: https://sanity.io/manage/project/${projectId2}/api` : this.message = "The current origin is not allowed to connect to the Live Content API.";
  }
};
var httpError = {
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-TY5N7SY4.js").then(function(n4) {
...
function _upload(client, httpRequest, assetType, body, opts = {}) {
  ...
  const config2 = client.config(), options = optionsFromFile(opts, body), { tag, label, title, description, creditLine, filename, source } = options, isMediaLibrary = ((_a = config2.resource) == null ? void 0 : _a.type) === "media-library", query = isMediaLibrary ? {
...
var LiveClient = class {
  ...
  events({
    ...
    const events = connectEventSource(() => (
      ...
      new URL(__privateGet(this, _client9).getUrl("/check/cors", false)),
      projectId2,
...
function checkCorsObservable(url, projectId2, requireCredentials) {
  return new Observable((observer) => {
    ...
    return fetch(url, { method: "GET", mode: "cors", credentials: "omit", signal }).then((response) => {
      ...
      var _a, _b;
      if (!signal.aborted) {
        if (requireCredentials && ((_a = body == null ? void 0 : body.result) == null ? void 0 : _a.withCredentials) === false) {
          observer.error(new CorsOriginError({ projectId: projectId2, credentials: true }));
          return;
        }
        if (((_b = body == null ? void 0 : body.result) == null ? void 0 : _b.allowed) === false) {
...
var ObservableMediaLibraryVideoClient = class {
  ...
  getPlaybackInfo(assetIdentifier, options = {}) {
    var _a;
    const config2 = __privateGet(this, _client12).config(), configMediaLibraryId = (_a = config2.resource || config2["~experimental_resource"]) == null ? void 0 : _a.id, { instanceId, libraryId } = parseAssetInstanceId(assetIdentifier), effectiveLibraryId = libraryId || configMediaLibraryId;
...
var _ObservableSanityClient = class _ObservableSanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    __privateAdd(this, _originalHttpRequest, void 0);
    ...
    __privateSet(this, _httpRequest15, requestHandler ? (() => {
      let bareClient;
  ...
  documentsExists(ids, options) {
    return _documentsExists(this, __privateGet(this, _httpRequest15), ids, options);
  }
...
var _SanityClient = class _SanityClient {
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    __privateAdd(this, _originalHttpRequest2, void 0);
    ...
    const requestHandler = config2._requestHandler;
    __privateSet(this, _httpRequest16, requestHandler ? (() => {
      let bareClient;
      return (options, requester2) => {
        const opts = options;
   ...
   */
  documentsExists(ids, options) {
    return lastValueFrom(_documentsExists(this, __privateGet(this, _httpRequest16), ids, options));
  }
  create(document2, options) {
    return lastValueFrom(
