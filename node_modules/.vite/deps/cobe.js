...
function H(e, t, r) {
  let a = {};
  for (let o of r)
    a[o] = e.getUniformLocation(t, o);
  return a;
}
function Q(e, t, r) {
  let a = {};
  for (let o of r)
    a[o] = e.getAttribLocation(t, o);
  return a;
}
function Ae(e) {
  ...
  return document.head.append(o), { m: function(e2, r2) {
    ...
    for (let e3 in t)
      o2[e3] || (t[e3].remove(), delete t[e3], delete a["--cobe-visible-" + e3]);
  }, a: function(e2, t2) {
    let o2 = {};
    for (let n of e2) {
      let e3 = n.id;
    ...
    for (let e3 in r)
      o2[e3] || (r[e3].remove(), delete r[e3], delete a["--cobe-visible-arc-" + e3]);
  }, r: function() {
    for (let e2 in t)
      t[e2].remove();
    for (let e2 in r)
...
var Pe = (e, t) => {
  ...
  function te(t2) {
    if (t2.phi != q && (f = t2.phi), t2.theta != q && (l = t2.theta), t2.markers && function(e2) {
      ...
      let t3 = 48;
      if (K(G.l, 3, t3, 0, 1), K(G.m, 3, t3, 12, 1), K(G.v, 1, t3, 24, 1), K(G.w, 1, t3, 28, 1), K(G.N, 3, t3, 32, 1), K(G.O, 1, t3, 44, 1), a.uniform1f(z.y, f), a.uniform1f(z.z, l), a.uniform2f(z.g, e.width, e.height), a.uniform1f(z.h, B), a.uniform2f(z.x, T[0] * n, T[1] * n), a.uniform3fv(z.M, h), a.uniform1f(z.A, p), o)
        a.drawArraysInstanced(a.TRIANGLE_STRIP, 0, 66, J);
      else if (i)
        i.drawArraysInstancedANGLE(a.TRIANGLE_STRIP, 0, 66, J);
      else
        for (let e2 = 0; e2 < J; e2++)
          a.drawArrays(a.TRIANGLE_STRIP, 0, 66);
    }
    if (C && c.length > 0) {
      ...
      K(L.p, 3, t3, 0, 1), K(L.q, 1, t3, 12, 1), K(L.w, 3, t3, 16, 1), K(L.x, 1, t3, 28, 1), a.uniform1f(P.i, f), a.uniform1f(P.j, l), a.uniform2f(P.b, e.width, e.height), a.uniform1f(P.k, B), a.uniform2f(P.r, T[0] * n, T[1] * n), a.uniform3fv(P.v, m), a.uniform1f(P.s, p), function(e2) {
        if (o)
          a.drawArraysInstanced(a.TRIANGLES, 0, 6, e2);
        else if (i)
          i.drawArraysInstancedANGLE(a.TRIANGLES, 0, 6, e2);
        else
